...
export module PG {
     ...
     * values. They are equivalent to the enum types supported in a number of programming
     * languages. An example of an enum type might be the days of the week, or a set of
     * status values for a piece of data.
     *
