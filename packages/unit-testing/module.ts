declare module "Unit-Testing" {
    ...
    export type State = jest.MatcherState & Record<string, object | number | string | boolean | null> & { data: object | string; prefix?: string };
}
...
declare module "IaC.API.Unit-Testing.Jest" {
// declare module "jest" {
    // @ts-ignore
    ...
    export interface Expect {
        ...
        getState(): MatcherState & Record<string, object | number | string | boolean> & { data: object | string; prefix?: string };
    }
